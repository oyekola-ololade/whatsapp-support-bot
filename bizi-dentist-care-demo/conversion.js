(()=>{
  ...
  logoStyle.textContent='.bizi-brand-logo{display:block;width:auto;object-fit:contain;border-radius:10px;box-shadow:0 8px 24px rgba(5,18,38,.16)}.bizi-brand-logo-top{width:84px;height:auto;max-height:100px}.bizi-official-wordmark{display:inline-flex;align-items:center;flex:none}.bizi-conversion-brand{margin-bottom:16px}.bizi-brand-logo-cta{width:128px;height:auto;max-height:152px}@media(max-width:700px){.bizi-brand-logo-top{width:72px;max-height:86px}.bizi-brand-logo-cta{width:108px;max-height:128px}}';
