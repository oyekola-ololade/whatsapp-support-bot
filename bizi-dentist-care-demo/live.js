...
function renderQuick(){
  ...
  const base=level===1?['Explore services','Request an appointment','I have tooth pain','I need a person']:['Explore services','Book an appointment','I have tooth pain','I need a person'];
