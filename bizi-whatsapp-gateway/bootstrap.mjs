...
const FOLLOWUP_LIVE_TEST=String(process.env.FOLLOWUP_LIVE_TEST||'false')==='true';
const FOLLOWUP_DEMO=String(process.env.FOLLOWUP_DEMO||'true')!=='false';
const FOLLOWUP_INTERVAL_MS=Math.max(60000,Number(process.env.FOLLOWUP_INTERVAL_MS||60000));
